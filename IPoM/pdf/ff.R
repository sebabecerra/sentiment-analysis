...
library(network)
library(readxl)
path="D:/SebaGIt/SentimientoVF/IPoM/pdf"
path1="D:/SebaGIt/SentimientoVF/IPoM/Excel/"
path2="D:/SebaGIt/SentimientoVF/IPoM/Cuerpo/ipom_plano/"
path3="D:/SebaGIt/SentimientoVF/IPoM/Cuerpo/ipom_x_palabra/"
...
mifuncion <- function(output, k) {
    ...
    write.csv(ief2, paste0(path2, gsub("IEF","", gsub(".pdf","",listief[k])),".txt"))
    ...
    write.csv(ief3, paste0(path3, gsub("IEF","", gsub(".pdf","",listief[k])),".txt"))
    #???write.csv(ief3, file=paste(k,".txt"))
}


#setwd('C:/Users/Asus/Desktop/Practica/IPoM')
listief <- dir(path,pattern = "*.pdf")
...
#***********************************************************************************************
paginas <- read_excel(paste0(path1,"paginas.xlsx") ) 
...
#LOS SIGUIENTES SOLO FUERON PARA PROBAR QUE LA FUNCIO?N TRABAJE BIEN
#2001_01 
